...
const Hero = () => {
  return (
    <div className="banner__hero mt-[100px] mx-[100px] relative">
      <img
        className="object-cover w-full h-[600px]"
        src="https://images.pexels.com/photos/1478442/pexels-photo-1478442.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
        alt=""
      />
      <div className="hero-bar absolute banner__hero top-1/2 w-full pl-2 ml-6">
        <p className="text-5xl text-white mb-2">All in One Sneaker Shop</p>
        <p className="text-4xl text-gray-300 mb-8">Over 200,000 Shoes</p>
        <Link to="/searched">
